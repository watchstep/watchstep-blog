...
![{1076C33F-D6B5-45A4-B2FB-2D310323C5CB}.png](1076C33F-D6B5-45A4-B2FB-2D310323C5CB.png)
...
> 임베딩 하나 안에 간략한 정보(coarse)부터 자세한 정보(fine)까지 순서대로 담아두자!
...
- $F(x_i;θ_F)$: 입력 x로부터 d차원 임베딩 벡터 z를 생성하는 생성망
...
class Matryoshka_CE_Loss(nn.Module):
	def __init__(self, relative_importance, **kwarges):
